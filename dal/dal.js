	...
	var dalInvoices = {
		...
		pay: (args) => {
			...
			.then(result => {
				...
				dalInvoices.errorResponse.error.errors[0].code 		= err.code 			|| dalInvoices.errorResponse.error.errors[0].code;
				dalInvoices.errorResponse.error.errors[0].reason	= err.description 	|| 'Add Invoice Error';
				dalInvoices.errorResponse.hiddenErrors.push(err.error);
				deferred.reject(dalInvoices.errorResponse);
			});			
		...
		get: (args) => {
			...
			.then(result => {
				...
				dalInvoices.errorResponse.error.errors[0].code 	= err.code 			|| dalInvoices.errorResponse.error.errors[0].code;
				dalInvoices.errorResponse.error.errors[0].reason 	= err.description 	|| 'Get Invoice Error';
				dalInvoices.errorResponse.hiddenErrors.push(err.error);
				deferred.reject(dalInvoices.errorResponse);
			});			
		...
		list: (args) => {
			...
			.then(result => {
				...
				dalInvoices.errorResponse.error.errors[0].code 	= err.code 			|| dalInvoices.errorResponse.error.errors[0].code;
				dalInvoices.errorResponse.error.errors[0].reason 	= err.description 	|| 'List Invoices Error';
				dalInvoices.errorResponse.hiddenErrors.push(err.error);
				deferred.reject(dalInvoices.errorResponse);
			});			
		...
		share: (args) => {
			...
			.then(result => {
				...
				dalInvoices.errorResponse.error.errors[0].code   = err.code 		|| dalInvoices.errorResponse.error.errors[0].code;
				dalInvoices.errorResponse.error.errors[0].reason = err.description || 'Share Invoice Error';
				dalInvoices.errorResponse.hiddenErrors.push(err.error);
				deferred.reject(dalInvoices.errorResponse);
			});
		...
		update: (args) => {
			...
			.then(result => {
				...
				dalInvoices.errorResponse.error.errors[0].code 	= err.code 			|| dalInvoices.errorResponse.error.errors[0].code;
				dalInvoices.errorResponse.error.errors[0].reason 	= err.description 	|| 'Update Invoice Error';
				dalInvoices.errorResponse.hiddenErrors.push(err.error);
				deferred.reject(dalInvoices.errorResponse);
			});			
		...
		delete: (args) => {
			...
			.then(result => {
				...
				dalInvoices.errorResponse.error.errors[0].code 	= err.code 			|| dalInvoices.errorResponse.error.errors[0].code;
				dalInvoices.errorResponse.error.errors[0].reason 	= err.description 	|| 'Remove Invoice Error';
				dalInvoices.errorResponse.hiddenErrors.push(err.error);
				deferred.reject(dalInvoices.errorResponse);
			});			
		...
		unsubscribe: (args) => {
			...
			.then(result => {
				...
				dalInvoices.errorResponse.error.errors[0].code   = err.code 		|| dalInvoices.errorResponse.error.errors[0].code;
				dalInvoices.errorResponse.error.errors[0].reason = err.description	|| 'Unsubscribe From Invoice Error';
				dalInvoices.errorResponse.hiddenErrors.push(err.error);
				deferred.reject(dalInvoices.errorResponse);
			});
		...
		updatesubscriber: (args) => {
			...
			.then(result => {
				...
				dalInvoices.errorResponse.error.errors[0].code 	= err.code 			|| dalInvoices.errorResponse.error.errors[0].code;
				dalInvoices.errorResponse.error.errors[0].reason 	= err.description 	|| 'Update Invoice Subscriber Error';
				dalInvoices.errorResponse.hiddenErrors.push(err.error);
				deferred.reject(dalInvoices.errorResponse);
			});			
